...
import DiceOne from "../assets/One.png";//we have to declare this image as a module(index.d.ts) otherwise it gives typescrit error
...
const Dice=({imageUrl}:DiceProps):JSX.Element=>{ //we can directly pass imageUrl as object but it is not makes usage of TS
  return(
    <View>
